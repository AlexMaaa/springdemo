...
//    }
            ...
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                if (clazz.isAnnotationPresent(Transactional.class)) {
                    ...
                    if (interfaces != null && interfaces.length > 0) {
                        //jdk
                        v = ((ProxyFactory) BeanFactory.getBean("proxyFactory")).getJdkProxy(v);
                    } else {
                        //cglib
                        v = ((ProxyFactory) BeanFactory.getBean("proxyFactory")).getCglibProxy(v);
                    }
                    map.put(value, v);
                }
            }
    ...
    private static void autowire() throws IllegalAccessException {
        for (Map.Entry<String, Object> entry : map.entrySet()) {
